...
const ArticlesModule: React.FC = () => {
    ...
    const { data: articlesStatistics, isLoading: isArticlesStatisticsLoading } = api.articles.getStatistics.useQuery();

    const statisticsLoading = isArticlesStatisticsLoading || sessionStatus === 'loading';
                        ...
                        <>
                            {permissions.canViewAllArticlesStatistics ? (
                                <>
                                    ...
                                    <Separator className="mx-4 h-[148px]" orientation="vertical" />
                                </>
                            ) : null}
                            <StatisticCard
                                title="Моїх статтей"
