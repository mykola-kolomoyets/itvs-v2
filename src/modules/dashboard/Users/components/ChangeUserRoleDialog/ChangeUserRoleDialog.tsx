...
const ChangeUserRoleDialog: React.FC<ChangeUserRoleDialogProps> = ({ user, ...rest }) => {
        ...
        <Dialog {...rest}>
            <DialogContent className="w-[90vw] max-w-[650px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Змініть праа доступів користувача, щоб дати йому можливість користуватися, або заборонити доступ
                        до певних функцій
                    </DialogDescription>
                </DialogHeader>
                <div>
                    <div className="flex items-center">
                        <Avatar className="mr-2">
                            <AvatarImage src={user?.image ?? ''} alt={user?.name ?? 'No Name'} />
                ...
                <DialogFooter>
                    <DialogClose asChild>
                        <Button className="mt-2" variant="secondary" disabled={isUserRoleUpdating}>
                            Відмінити
                        </Button>
                    </DialogClose>
                    <Button
                    ...
                    >
                        {isUserRoleUpdating ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
                        Оновити
                    </Button>
                </DialogFooter>
            </DialogContent>
